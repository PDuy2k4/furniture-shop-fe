    ...
    return (
        <>
            <img
                ...
                alt='funitute' className='lg:hidden absolute top-0 left-0 w-full h-full object-center object-cover z-0'
            />
                ...
                <div className='px-3 lg:px-8  w-[100%] lg:w-[45%] flex flex-col items-stretch justify-between pt-10 pb-1 rounded-[34px]'>
                    ...
                    <form>
                        ...
                        <input
                            ...
                            type='email' className='peer mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-[#7F265B] focus:ring-[#7F265B] block w-full rounded-md sm:text-sm focus:ring-1'
                        ...
                        <input
                            value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Enter password'  type={showPassword ? 'text' : 'password'} className='mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 focus:outline-none focus:border-[#7F265B] focus:ring-[#7F265B] block w-full rounded-md sm:text-sm focus:ring-1'
                        />
                        <button type='button' className='absolute right-2 top-[50%] ' onClick={changeShowPasswordIcon}>
                            <img  src={showPassword ? show : hide} className='inline-block rounded-[100rem] w-5 h-5 hover:bg-slate-200' alt='Toggle password visibility'
                            />
                        </button>
                        </label>
